...
menu.add_player_feature("SE Kick", "action", popt.opption, function(feat, pid)
	par1 = math.random(-99999999999999, -9999999)
	for i = 1, 2 do 
			system.yield(50)
		...
		script.trigger_script_event(-1991317864, pid, {pid, -1, -1, -1, -1})
			system.yield(50)
		script.trigger_script_event(-120329143, pid, {par1, par1})
			system.yield(50)
		script.trigger_script_event(-823334279, pid, {-1, -1})
			system.yield(50)
		script.trigger_script_event(-279342915, pid, {-1, -1})
			system.yield(50)
		script.trigger_script_event(1902624891, pid, {-1, -1})
			system.yield(50)
		script.trigger_script_event(-614457627, pid, {-1, -1})
			system.yield(50)
	end
